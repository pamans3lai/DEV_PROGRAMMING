...
def check_ans(questions, ans, attempts, score):
    """
    Takes the arguments, and confirms if the answer provided by user is correct.
        Converts all answer to lower case to make sure the quiz is not case sensitive.
        """
    if quiz[questions]['answer'].lower() == ans.lower():
